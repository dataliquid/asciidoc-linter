...
public final class AdmonitionBlockValidator extends AbstractBlockValidator<AdmonitionBlock> {
    ...
    @Override
    protected List<ValidationMessage> performSpecificValidations(StructuralNode block, AdmonitionBlock admonitionConfig,
    ...
    private void validateType(String admonitionType, AdmonitionBlock.TypeConfig config, AdmonitionBlock blockConfig,
    ...
    private void validateTitle(String title, AdmonitionBlock.TitleConfig config, AdmonitionBlock blockConfig,
            BlockValidationContext context, StructuralNode block, List<ValidationMessage> messages) {
    ...
    private void validateContent(String content, AdmonitionBlock.ContentConfig config, AdmonitionBlock blockConfig,
            BlockValidationContext context, StructuralNode block, List<ValidationMessage> messages) {
    ...
    private void validateLines(String content, com.dataliquid.asciidoc.linter.config.rule.LineConfig config,
            AdmonitionBlock.ContentConfig contentConfig, AdmonitionBlock blockConfig, BlockValidationContext context,
    ...
    private void validateIcon(boolean hasIcon, AdmonitionBlock.IconConfig config, AdmonitionBlock blockConfig,
            BlockValidationContext context, StructuralNode block, List<ValidationMessage> messages) {
     ...
     */
    private SourcePosition findTypePosition(StructuralNode block, BlockValidationContext context,
